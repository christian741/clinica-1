...
public partial class View_Paciente_Default : System.Web.UI.Page
{
    ...
    protected void button_cita_Click(object sender, EventArgs e)
    {
        ...
        Cita cita = new Cita();
        cita.Especializacion = Convert.ToInt32(DDL_especial.SelectedValue);
        cita.Doctor = Convert.ToInt32(DDL_doctor_cita.SelectedValue);
        cita.Paciente = Convert.ToInt32(Session["usuario"].ToString());
        cita.Sede = Convert.ToInt32(DDL_sede_cita.SelectedValue);
        ...
        else
        {
            ...
            Label_error_especial.Text = "";
            Label_error_especial.CssClass = null;
