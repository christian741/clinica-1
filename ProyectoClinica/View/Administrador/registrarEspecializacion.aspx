<%@ Page Title="Registro Especialización" Language="C#" MasterPageFile="~/View/Administrador/masterAdministrador.master" AutoEventWireup="true"
    CodeFile="~/Controller/ConAdministrador/registrarEspecializacion.aspx.cs" Inherits="View_Administrador_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <asp:FileUpload ID="FU_registro_esp" runat="server" />
                ...
                <br /><asp:DropDownList ID="DDL_edad_esp" runat="server">
            ...
            <br />
             <asp:Label ID="label_prioridad" runat="server" Text="Seleccione los Permisos que Tiene la Especialización"></asp:Label>
                <br /><asp:DropDownList ID="DDL_prioridad" runat="server">
