<%@ Page Title="" Language="C#" MasterPageFile="~/View/Administrador/masterAdministrador.master" AutoEventWireup="true" 
    CodeFile="~/Controller/ConAdministrador/verSedes.aspx.cs" Inherits="View_Administrador_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="container-fluid" style="text-align:center;background-color:black;color:white">
    ...
    <div class="table-responsive" style="text-align:center;">  
        ...
        <asp:GridView ID="GV_sedes" runat="server" AllowPaging="True" style="max-width:100%" CssClass="table-hover" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="OBDS_sede" DataKeyNames="id_sede" Width="100%"  OnRowDataBound="cargar_Botones_RowDataBound" OnRowCommand="GV_Sede_RowCommand" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal">
            <Columns>
...
<HeaderStyle CssClass="thead-dark"></HeaderStyle>
        ...
        <asp:ObjectDataSource ID="OBDS_sede" runat="server" SelectMethod="ver_Sede" TypeName="DAOSede"></asp:ObjectDataSource>
