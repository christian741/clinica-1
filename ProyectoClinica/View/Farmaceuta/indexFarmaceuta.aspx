<%@ Page Title="" Language="C#" MasterPageFile="~/View/Farmaceuta/masterFarmaceuta.master" AutoEventWireup="true"
    CodeFile="~/Controller/ConFarmaceuta/indexFarmaceuta.aspx.cs" Inherits="View_Farmaceuta_Default" %>
    ...
    <table class="table table-sm">
      <thead>
        <tr >
            ...
            <caption>Información del Farmaceuta</caption>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td> <asp:Label ID="label5" runat="server"  Text="Dirección:"></asp:Label>   
