<%@ Page Title="" Language="C#" MasterPageFile="~/View/Laboratorista/masterLaboratorista.master"
    AutoEventWireup="true" CodeFile="~/Controller/ConLaboratorista/editarUsuario.aspx.cs" Inherits="View_Laboratorista_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      <asp:Panel ID="ModalPanel" runat="server" >
           ...
           <div class="alert alert-danger" >
                ...
                <asp:Label ID="label_advertencia" runat="server" Text=""></asp:Label><br /> <br />
                       
             </div>
            <asp:Button CssClass="btn btn-outline-danger"  id="but_aceptar" runat="server" text="Aceptar" OnClick="but_aceptar_Click"  />
...
<div class="table-responsive">
    <table class="table table-sm">
      <thead>
        <tr >
            ...
            <caption>Información del Laboratorista</caption>
    ...
    <asp:ObjectDataSource ID="OBDS_usuario" runat="server" SelectMethod="buscar_Usuario" TypeName="DAOUsuario">
        <SelectParameters>
            <asp:SessionParameter Name="cedula" SessionField="usuario" Type="Int32" />
        </SelectParameters>
