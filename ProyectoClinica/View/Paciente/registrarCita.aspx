<%@ Page Title="" Language="C#" MasterPageFile="~/View/Paciente/masterPaciente.master" AutoEventWireup="true" 
    CodeFile="~/Controller/ConPaciente/registrarCita.aspx.cs" Inherits="View_Paciente_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <asp:UpdatePanel ID="UpdatePanel1" runat="server">
         <ContentTemplate>
              <asp:Label ID="Label_error_especial" runat="server" Text="" Visible="false"></asp:Label>
             <br /><br /><br />
             <asp:Label ID="label_especial" runat="server" Text="Seleccione una Especialización:"></asp:Label>
             <br />
             <asp:DropDownList ID="DDL_especial" runat="server" AutoPostBack="True" DataSourceID="OBDS_especial" DataTextField="nombre" DataValueField="id" OnSelectedIndexChanged=" buscarSede_SelectedIndexChanged">
             </asp:DropDownList>
             <br />
             <asp:ObjectDataSource ID="OBDS_especial" runat="server" SelectMethod="especial_Paciente" TypeName="DAOEspecializacion">
                 <SelectParameters>
                     <asp:SessionParameter Name="paciente" SessionField="usuario" Type="Int32" />
                 </SelectParameters>
